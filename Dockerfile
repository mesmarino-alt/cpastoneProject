...
RUN python -m pip install --upgrade pip setuptools wheel \
    ...
    && python -m pip install --no-cache-dir Flask==3.1.2 Flask-Bcrypt==1.0.1 Flask-Login==0.6.3 "PyMySQL[rsa]==1.1.2" \
